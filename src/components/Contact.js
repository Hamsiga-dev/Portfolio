...
export default function Contact(){
    const config = {
        ...
        email: 'srihamsiga.dev@gmail.com',
        phone : '0764728456'
    }
    ...
    return <section id='contact' className='flex flex-col bg-primary px-5 py-32' >
        <div className='flex flex-col items-center'>
                ...
                <p className="text-white pb-5"><span className="font-bold"> Email : </span>{config.email} </p>
                <p className="text-white pb-5"><span className="font-bold"> Phone : </span>{config.phone} </p>
        </div>
    </section>
}